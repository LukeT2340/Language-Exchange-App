...
struct NoteDetailView: View {
    ...
    init(noteService: NoteService, messageService: MessageService, userService: UserService, noteId: String) {
    ...
    private var textFieldView: some View {
        HStack {
            KFImage(userService.clientUser.compressedProfileImageUrl)
                .resizable()
                .aspectRatio(contentMode: .fill) // This will fill the frame and may clip the image
